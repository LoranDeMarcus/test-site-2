...
const resultData = [3, 2, 4, 3, 2, 5, 1, 3]
...
export const BussDurkee = () => {
  ...
  const renderErrorFields = () => {
    ...
    for (const [key, value] of Object.entries(errors)) {
      errorsArray.push(value.ref.name)
    }
    ...
    <PageWrapper>
      <Container>
        <Wrapper>
          ...
          {!hasReadDescription && !isDone && (
            <>
              <s.Subtitle>
                ...
                Опросник включает в себя 56 утверждений, на которые необходимо ответить «ДА» или
                «НЕТ».
                Ответы на утверждения человек дает, основываясь на себя, своей реакции на других
                людей или же на какие-то события.
                Отметьте «да», если вы согласны с утверждением, и «нет» - если не согласны.
                Старайтесь долго над вопросами не раздумывать.
              </s.Subtitle>
              <Button onClick={() => setHasReadDescription(true)} className={s.StartButton}>
                Начать тестирование
              </Button>
            </>
          )}
          {hasReadDescription && !isDone && (
            <>
              <Button onClick={() => setHasReadDescription(false)} className={s.ReturnButton}>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className={s.form}>
                ...
                <s.QuestionWrapper>
                  <s.Question>
                    8. Когда мне случалось обмануть кого-нибудь, я испытывал мучительные угрызения
                    совести
                  </s.Question>
                  <s.Answers>
                    <Controller
                ...
                <s.QuestionWrapper>
                  <s.Question>
                    62. Если для защиты своих прав мне нужно применить физическую силу, я применяю
                    ее
                  </s.Question>
                  <s.Answers>
                    <Controller
              ...
              {isError && (
                <s.Error>
                  <b>Вы не ответили на вопросы:</b> {renderErrorFields()}
                </s.Error>
              )}
            </>
          )}
          {hasReadDescription && isDone && (
            <s.ResultWrapper>
              ...
              <s.TestResultWrapper>
                <s.TestResult>
                  <s.TestResultText>
                    <s.Color bgc='rgb(255, 99, 132)' /> Физическая агрессия - 3
                  </s.TestResultText>
                  <s.TestResultText>
                    <s.Color bgc='rgb(54, 162, 235)' /> Косвенная агрессия - 2
                  </s.TestResultText>
                  <s.TestResultText>
                    <s.Color bgc='rgb(255, 205, 86)' /> Раздражение - 4
                  </s.TestResultText>
                  <s.TestResultText>
                    <s.Color bgc='rgb(75, 192, 192)' /> Вербальная агрессия - 3
                  </s.TestResultText>
                  <s.TestResultText>
                    <s.Color bgc='rgb(245, 2, 87)' /> Обида - 2
                  </s.TestResultText>
                  <s.TestResultText>
                    <s.Color bgc='rgb(153, 102, 255)' /> Подозрительность - 5
                  </s.TestResultText>
                  <s.TestResultText>
                    <s.Color bgc='rgb(9, 213, 186)' /> Негативизм - 1
                  </s.TestResultText>
                  <s.TestResultText>
                    <s.Color bgc='rgb(1,41,116)' /> Чувство вины - 3
                  </s.TestResultText>
                </s.TestResult>
                <s.ChartWrapper>
